...
{
    public class FigurineServiceTests
    {
        public ServiceProvider BuildServiceProvider(string dbName)
        {
            var serviceProvider = new ServiceCollection()
                ...
                .AddScoped<IDataService<Quinlan.Data.Models.Collectible>, CollectibleDataService>()
                .AddScoped<ICrudService<Figurine>, FigurineService>()
